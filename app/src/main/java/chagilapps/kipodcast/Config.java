...
public class Config {
    ...
    public static final String PURCHASECODE = "92451ff3-6f86-4238-969b-97aa9da6cf38";
    // 4. Enjoy your app! :)
    ...
    public static final int SPLASH_TIMEOUT = 3500;
    ...
    static boolean darkStatusBarText = true;
    ...
    static boolean requireStorage = false; //Set to "false" if you do NOT require APIs related to downloads or uploads
